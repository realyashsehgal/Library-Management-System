...
public class TransactionManager {
    ...
    {
        if(transaction.getStudentErp().isEmpty() || transaction.getBookId().isEmpty() || transaction.getType().isEmpty())
        {
        ...
        if((book = BookManager.getBook(transaction.getBookId())) == null)
        {
        ...
        BookManager.setAvailability(book.getId(), UNAVAIALABLE);
    ...
    public static String addReturn(Transaction transaction)
    {
        ...
        BookManager.setAvailability(book.getId(), AVAIALABLE);
        return "SUCCESS";
        }
        catch(SQLException e)
        {
